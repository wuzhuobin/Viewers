...
import ConnectedBrainnowToolbarRow from './ConnectedBrainnowToolbarRow.js';
import ConnectedStudyBrowser from './ConnectedStudyBrowser.js';
import ConnectedBrainnowViewerMain from './ConnectedBrainnowViewerMain.js';
      ...
      <>
        ...
        <div className="FlexboxLayout">
          ...
          <div className={classNames('main-content')}>
            <ConnectedBrainnowViewerMain studies={this.props.studies} />
          </div>
...
export default withDialog(BrainnowViewer);
